...
**A note on production use** — A real production environment would reach for
...
Kafka Connect in distributed mode requires running and monitoring a separate fleet of worker processes with their own REST API and coordinator.
